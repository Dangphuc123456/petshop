    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item text-center small text-gray-500" href="{{ route('admin.order.index') }}">Xem Tất Cả</a>
            </div>
        </li>
        ...
        fetch('/admin/notifications/new-orders')
            ...
            .then(data => {
                ...
                if (data.length > 0) {
                    ...
                    data.forEach(order => {
                        // Generate the route using Laravel's route helper
                        const orderUrl = `/admin/order/detail/${order.order_id}`;  // Dynamic URL
                        ...
                        alertsContainer.innerHTML += `
                            <a class="dropdown-item d-flex align-items-center" href="${orderUrl}">
                                ...
                                <div>
                                    ...
                                    <div class="text-gray-500">Số tiền: ${order.total_amount.toLocaleString()}đ</div>
                                </div>
                            </a>
                        `;
                    });
